/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: 55c6d8c45292929604ed9e60d95aa58d)
// Runtime types generated with workerd@1.20260302.0 2025-12-01 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		...
		NEXTJS_ENV: string;
		DATABASE_URL: string;
		WORKER_SELF_REFERENCE: Fetcher /* tully-sh */;
	}
}
