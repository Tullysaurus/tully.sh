    ...
    >
      ...
      <div className="flex flex-1 flex-col gap-2 p-4 text-white">
        <div className="flex items-start justify-between gap-3">
          ...
          {!showImage && (
            <div className="shrink-0 rounded bg-[#f5b041] px-2 py-1 text-xs font-semibold text-black">
              <div className="leading-none text-center">
                <div>{dayOfMonth}</div>
                <div className="text-[10px]">{month}</div>
              </div>
        ...
        <span className="mt-auto pt-1 text-sm font-medium text-[#f5b041] flex flex-row items-center">
          View
