...
import { BugPlay, CloudUpload, Github, House, Key, Megaphone, Router, Terminal } from "lucide-react";
      ...
      <div className="mt-3 flex w-full flex-col justify-center gap-3 lg:mt-auto">
        {pathname.startsWith("/cheats") && (
          <button
            ...
            className="flex w-full cursor-pointer items-center justify-center gap-2 rounded bg-[#f5b041] py-2 font-bold text-black transition-transform active:scale-[0.98] hover:bg-[#d49b3b]"
          >
            <Key size={20} />
            Enter Key
          </button>
