...
export default function RootLayout({
  ...
  return (
    <html lang="en">
        <head>
          <link rel="icon" type="image/png" sizes="16x16" href="https://tully.sh/icons/favicon.ico" />
          <link rel="icon" type="image/png" sizes="32x32" href="https://tully.sh/icons/favicon-32x32.png" />
          <link rel="icon" type="image/x-icon" sizes="16x16" href="https://tully.sh/icons/favicon-16x16.png" />
        </head>
